...
public static class MemorySubAgentPrompt
{
    public const string UPDATE =
        ...
        状态更新: 叙事中出现影响状态属性的变化时, 根据上下文表格中的属性调用工具更新。全局数值属性用 update_state 传入变化量; 人物数值属性用 update_character_state。叙事驱动枚举属性使用 set_state 或 set_character_state 设置为上下文表格列出的选项。文本属性根据规则中的叙事生成指引自行生成任意文本, 使用 set_state 或 set_character_state 写入。无相关变化时跳过。
